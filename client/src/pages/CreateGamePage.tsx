...
export default function CreateGamePage() {
  ...
  return (
    <div className="max-w-md mx-auto mt-12 px-4">
      <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Create a Game</h2>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Voting System</label>
          <div className="px-3 py-2 border border-gray-200 rounded-lg bg-gray-50 text-gray-600 text-sm dark:bg-[var(--bg-tertiary)] dark:border-[var(--border-default)] dark:text-[var(--text-secondary)]">
        ...
        {/* Table theme */}
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Table Theme</label>
          <select
            value={tableTheme}
            onChange={e => setTableTheme(e.target.value as TableTheme)}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white text-sm dark:bg-[var(--input-bg)] dark:border-[var(--input-border)] dark:text-[var(--text-primary)]"
          >
            {getAllThemes().map(t => (
