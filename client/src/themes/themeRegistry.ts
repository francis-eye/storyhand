...
const classicTheme: ThemeConfig = {
  ...
  header: {
    ...
    text: '',
    gameName: 'text-gray-800',
    roundText: 'text-gray-500',
    phaseChip: {
      waiting: 'bg-gray-200 text-gray-700',
      voting: 'bg-blue-100 text-blue-700',
      countdown: 'bg-amber-100 text-amber-700',
      revealed: 'bg-green-100 text-green-700',
    },
    reVotingChip: 'bg-orange-100 text-orange-700',
    inviteButton: 'bg-blue-600 text-white hover:bg-blue-700',
    inviteButtonHover: '',
    sessionIdButton: 'bg-white border border-gray-200 hover:bg-gray-50',
    sessionIdText: 'text-gray-700',
  },
  table: {
    background: 'bg-gradient-to-br from-emerald-100 to-emerald-50',
    border: 'border border-emerald-200 rounded-2xl',
    emptyText: 'text-emerald-400',
    voteCountText: 'text-gray-500',
    scanlines: false,
  },
  card: {
    faceUpBg: 'bg-white',
    faceUpBorder: 'border-gray-300',
  ...
  roster: {
    ...
    nameDisconnectedText: 'text-gray-400',
    disconnectedLabel: 'text-red-500',
    votedText: 'text-green-600',
    thinkingText: 'text-gray-400',
    transferButton: 'text-gray-400 hover:text-blue-600 hover:bg-blue-50',
  },
  results: {
    background: 'bg-white shadow-lg',
    consensusBg: 'bg-green-50',
    consensusBorder: 'border-green-200',
    consensusText: 'text-green-700',
    varianceBg: 'bg-amber-50',
    varianceBorder: 'border-amber-200',
    varianceText: 'text-amber-700',
    averageLabel: 'text-gray-500',
    averageValue: 'text-gray-800',
    voteCountText: 'text-gray-500',
    barBg: 'bg-gray-100',
    barFill: 'bg-blue-500',
